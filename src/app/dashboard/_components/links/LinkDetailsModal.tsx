...
export function LinkDetailsModal({ isOpen, onClose, links: dataLinks }: LinkDetailsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md mx-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">{dataLinks.title}</DialogTitle>
        </DialogHeader>
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-sm">{dataLinks.description || "Sem descrição"}</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:gap-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-1">Pasta</h3>
